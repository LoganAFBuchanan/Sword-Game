...
public class EnemyController : MonoBehaviour
{
    ...
    public void moveEnemy()
    {
        ...
        // //Up
        // if (destVector.y > transform.position.y && Mathf.RoundToInt(destVector.x) == Mathf.RoundToInt(transform.position.x))
        // {
        //     StartCoroutine(moveScript.move(enemyTransform, new Vector2(0, 1)));
        //     return;
        // }
        ...
        // }
        // //Right
        // if (destVector.x > transform.position.x && Mathf.RoundToInt(destVector.y) == Mathf.RoundToInt(transform.position.y))
        // {
        //     StartCoroutine(moveScript.move(enemyTransform, new Vector2(1, 0)));
        //     return;
        // }
